...
function addPassengerBubble(result) {
  ...
  div.className = 'chat-msg chat-msg-passenger';
  // 괄호 안 지문을 이탤릭체로 변환
  const formattedResponse = escapeHtml(result.passengerResponse)
    .replace(/\(([^)]+)\)/g, '<em class="chat-stage-dir">$1</em>');
  div.innerHTML = `
    <span class="chat-avatar-p" style="background:${p.avatarGrad}">
      <span style="font-size:13px;font-weight:900;color:#fff">${p.initial}</span>
    </span>
    <div class="chat-content-p">
      <div class="chat-bubble chat-bubble-passenger"><p>${formattedResponse}</p></div>
      <div class="chat-meta-p">
        <button class="btn-tts-chat" data-text="${escapeHtml(result.passengerResponse.replace(/\([^)]+\)\s*/g, ''))}">🔊 듣기</button>
...
function initRecognition() {
  ...
  recognition.onend = () => {
    if (isRecording) {
      // 약간의 딜레이 후 재시작 (브라우저 내부 상태 정리 대기)
      setTimeout(() => { if (isRecording && recognition) recognition.start(); }, 80);
    }
  };
}
...
▶ 승객 응답 규칙
- 방금 받은 응대에 실제 그 자리에 있는 사람처럼 자연스럽게 반응하세요 (1~3문장)
- 사무장이 언급한 구체적 내용(비행시간·날씨·서비스)에 짧게 반응하세요 (예: "날씨 정보 감사해요", "아메리카노 한 잔 주세요")
- 이전 대화 맥락을 자연스럽게 이어가세요: 2단계→음료·서비스 요청, 3단계→마무리 인사
- 호칭이 틀려도 직접 지적하지 않고 거리감 있게 반응하세요 (차갑지는 않지만 따뜻하지도 않게)
- 응대 품질에 따라 반응 온도만 달라집니다: 미흡→짧고 건조, 우수→짧고 따뜻, 탁월→만족감이 자연스럽게 묻어남
- 괄호 안 지문(예: "(고개를 끄덕이며)")은 꼭 필요할 때만, 최대 1개만 사용하세요
  ...
  1: { // VIP · 이재명 대통령
    ...
    roundReactions: {
      1: { // 탑승 인사
        ...
        good: [
          '감사합니다. 비행 정보까지 챙겨주시니 마음이 놓이네요.',
          '날씨 정보도 알려주시니 도착 준비가 되네요. 잘 부탁드립니다.',
          '고맙습니다. 필요한 것 있으면 말씀드리겠습니다.',
        ],
        excellent: [
          '감사합니다. 비행 정보와 날씨까지 자연스럽게 안내해주시니 한결 편안하네요. 잘 부탁드립니다.',
          '딱 필요한 정보를 간결하게 전달해주셨어요. 편한 마음으로 가겠습니다.',
          '감사합니다. 오늘 비행 기대가 됩니다.',
        ],
      },
      2: { // 서비스 안내
        ...
        good: [
          '아메리카노 한 잔 부탁드립니다. 감사합니다.',
          '따뜻한 녹차 있으면 좋겠네요. 잘 부탁드립니다.',
          '커피 한 잔 부탁드려도 될까요?',
        ],
        excellent: [
          '아메리카노 한 잔 부탁드립니다. 필요한 것 있으면 제가 말씀드릴게요. 감사합니다.',
          '커피 한 잔 주세요. 세심하게 안내해주시니 감사합니다.',
          '따뜻한 아메리카노 주시면 됩니다. 수고하세요.',
        ],
      },
      3: { // 마무리 인사
        wrongTitle: [
        ...
        good: [
          '수고하셨어요. 덕분에 편안한 비행이었습니다.',
          '감사합니다. 잘 돌봐주셨네요.',
          '고맙습니다. 좋은 비행이었어요.',
        ],
        excellent: [
          '정말 감사합니다. 덕분에 아주 편안한 비행이었어요. 수고하셨습니다.',
          '비행 내내 세심하게 챙겨주셔서 고마웠습니다. 수고하셨어요.',
          '좋은 서비스였습니다. 수고하셨어요.',
        ],
      },
    },
  ...
  2: { // CIP · 이재용 삼성전자 대표
    ...
    roundReactions: {
      1: {
        ...
        good: [
          '감사합니다. 비행 정보까지 챙겨주시니 편하네요.',
          '날씨 정보도 유용하게 들었습니다. 잘 부탁드립니다.',
          '필요한 내용을 잘 전달해주셨어요. 감사합니다.',
        ],
        excellent: [
          '감사합니다. 비행시간과 날씨까지 바로 안내해주시니 역시 제주항공이에요. 잘 부탁드립니다.',
          '딱 맞는 정보를 간결하게 전달해주셨어요. 편안한 비행이 될 것 같습니다.',
          '간결하면서도 필요한 건 다 있었어요. 감사합니다.',
        ],
      },
      2: {
        wrongTitle: [
        ...
        good: [
          '아메리카노 한 잔 부탁드립니다. 감사합니다.',
          '따뜻한 커피 한 잔이면 충분합니다. 감사해요.',
          '커피 주시면 됩니다. 잘 부탁드립니다.',
        ],
        excellent: [
          '아메리카노 한 잔 주세요. 자연스럽게 안내해주시니 감사합니다.',
          '커피 한 잔 부탁드립니다. 필요하면 제가 다시 말씀드릴게요.',
          '아메리카노 주세요. 프로페셔널하게 안내해주셨어요.',
        ],
      },
      3: {
        wrongTitle: [
        ...
        excellent: [
          '감사합니다. 쾌적하고 편안한 비행이었어요. 수고하셨습니다.',
          '비행 내내 잘 챙겨주셨어요. 수고하셨습니다.',
          '자연스럽고 프로페셔널했어요. 감사합니다.',
        ],
      },
    },
  },
  3: { // AIP · 채형석 애경그룹 회장
    ...
    roundReactions: {
      1: {
        ...
        good: [
          '감사합니다. 비행 정보도 알려주시니 든든하네요.',
          '날씨 정보까지 세심하게 챙겨주시는군요. 잘 부탁드립니다.',
          '필요한 것을 자연스럽게 전달해주셨네요. 감사합니다.',
        ],
        excellent: [
          '잘 알겠습니다. 비행시간과 날씨까지 챙겨주시니 역시 제주항공이에요. 잘 부탁드립니다.',
          '간결하고 품격 있는 안내였어요. 편안한 비행이 될 것 같습니다.',
          '감사합니다. 직원 교육이 잘 되어 있군요.',
        ],
      },
      2: {
        wrongTitle: [
        ...
        good: [
          '따뜻한 녹차 한 잔 부탁드릴게요. 감사합니다.',
          '오렌지 주스 주세요. 잘 챙겨주시네요.',
          '녹차 한 잔 주시면 됩니다. 감사합니다.',
        ],
        excellent: [
          '녹차 한 잔 부탁드립니다. 세심하게 안내해주시니 감사합니다.',
          '따뜻한 차 한 잔 주세요. 서비스가 자연스럽고 좋군요.',
          '녹차 주시면 됩니다. 잘 훈련된 승무원이에요.',
        ],
      },
      3: {
        wrongTitle: [
        ...
        excellent: [
          '감사합니다. 덕분에 아주 편안한 비행이었어요. 수고하셨습니다.',
          '비행 내내 자연스럽고 품격 있는 서비스였습니다. 수고하셨어요.',
          '제주항공 서비스 수준을 잘 보여주셨어요. 감사합니다.',
        ],
      },
    },
  },
  4: { // AAIP · 김이배 제주항공 대표이사
    ...
    roundReactions: {
      1: {
        ...
        good: [
          '감사합니다. 비행 정보까지 챙겨주시니 좋네요.',
          '날씨 정보도 유용합니다. 편안한 비행이 될 것 같아요.',
          '간결하게 잘 안내해주셨어요. 잘 부탁드립니다.',
        ],
        excellent: [
          '잘 했어요. 비행 정보와 날씨를 자연스럽게 담아주셨어요. 잘 부탁드립니다.',
          'JJEMS 규정대로 간결하면서도 필요한 정보를 다 전달해주셨어요. 감사합니다.',
          '딱 좋은 Greeting이었어요. 이렇게 유지해줘요.',
        ],
      },
      2: {
        wrongTitle: [
        ...
        good: [
          '아메리카노 한 잔 주세요. 감사합니다.',
          '커피 한 잔 부탁드릴게요. 잘 안내해주셨어요.',
          '아메리카노 주시면 됩니다. 감사합니다.',
        ],
        excellent: [
          '아메리카노 주세요. 자연스럽게 안내해주셔서 좋았어요. 더 필요하면 말씀드릴게요.',
          '커피 한 잔 부탁드립니다. 직원들이 잘 훈련되어 있어 보기 좋네요.',
          '아메리카노 주세요. 서비스 품질이 기대에 맞아요.',
        ],
      },
      3: {
        wrongTitle: [
        ...
        excellent: [
          '수고하셨습니다. 비행 내내 자연스럽고 프로페셔널하게 잘 해주셨어요.',
          '편안한 비행이었습니다. 앞으로도 이 수준 유지해줘요. 감사합니다.',
          'JJEMS 표준을 잘 지켜줬어요. 수고하셨습니다.',
        ],
      },
    },
  },
...
async function getDemoResponse(passenger, greeting) {
  ...
  // analysis.tier 우선 사용 (wrongTitle/tooShort 포함), 없으면 점수 기반
  const tierKey = analysis.tier === 'wrongTitle' ? 'wrongTitle'
    : analysis.tier === 'tooShort' ? 'brief'
    : analysis.score >= 88 ? 'excellent'
    : analysis.score >= 73 ? 'good'
    : analysis.score >= 50 ? 'ok'
    : 'brief';

  // 라운드별 자연스러운 반응 선택
  const roundPool = data.roundReactions?.[conversationRound] || data.roundReactions?.[1];
  const passengerResponse = pick(roundPool?.[tierKey] || roundPool?.ok);
